...
total_availability = 70_000_000
needed = 30_000_000

sizes = data.values.sort
total_used = sizes.last

current_availability = total_availability - total_used
p current_availability
p needed

pp sizes.find { needed <= current_availability + _1 }
